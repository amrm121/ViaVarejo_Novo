class Pagamento < SitePrism::Page
    ...
    element :msg_compra_concluida,  :xpath,     '//div[@id="bannerPadding_1513173879"]//child::a[1][@style="text-decoration:none; color:#c82b36; font-size:30px; font-weight:normal; "]'    
